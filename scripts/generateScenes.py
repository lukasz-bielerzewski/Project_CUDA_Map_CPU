...
models_prefix = "/home/dominik/Sources/walkers/resources/models"
...
#categories = ["shapeNetGraspable_30instances_bottle", "shapeNetGraspable_30instances_box",
#    "shapeNetGraspable_30instances_can", "shapeNetGraspable_30instances_cube",
#    "shapeNetGraspable_30instances_helmet", "shapeNetGraspable_30instances_jar",
#    "shapeNetGraspable_30instances_laptop", "shapeNetGraspable_30instances_mug"]
...
for category in categories :
    tree_config = ET.parse('../../resources/scene_graspable.xml')
    ...
    tree_config.write('../../resources/scene_graspable.xml')
    ...
    while matching_files < number_of_files :
        ...
        matching_files = len(filelist)/3
        os.system(r"./sceneGenerator")

    #reproject images
    os.system(r"./reprojectImgsParts")

    #copy results
    os.system(r"mkdir shapeNetGraspable\_30instances")
    os.system(r"mkdir shapeNetGraspable\_30instances/" + str(category))
    os.system(r"pwd")
    #os.system(r"mv dataset/\* shapeNetGraspable_30instances/" + str(category))
    source_dir = 'dataset'
    target_dir = "shapeNetGraspable_30instances/" + str(category)
