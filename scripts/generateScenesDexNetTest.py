...
for category in categories :
    tree_config = ET.parse('../../resources/scene_graspable_Dexnet_test.xml')
...
#                child_config.attrib["file"] = models_path_tables
    ...
    tree_config.write('../../resources/scene_graspable_Dexnet_test.xml')
    ...
    #copy results
    os.system(r"mkdir shapeNetGraspable\_30instances_DexNet_Test")
    os.system(r"mkdir shapeNetGraspable\_30instances_DexNet_Test/" + str(category))
    os.system(r"pwd")
    #os.system(r"mv dataset/\* shapeNetGraspable_30instances_DexNet_Test/" + str(category))
    source_dir = 'dataset'
    target_dir = "shapeNetGraspable_30instances_DexNet_Test/" + str(category)
