...
public:
    ...
    void train(const Eigen::MatrixXd& inputTrain, const Eigen::MatrixXd& outputTrain);
    ...
    /// write summary
    void writeSummary(const Eigen::MatrixXd& inputTest, const Eigen::MatrixXd& outputTest);
