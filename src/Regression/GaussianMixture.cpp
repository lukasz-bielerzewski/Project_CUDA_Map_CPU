...
void GaussianMixture::train(const Eigen::MatrixXd& inputTrain, const Eigen::MatrixXd& outputTrain){
    features = inputTrain;
    output = outputTrain;
    // TODO compute input domain
    train();
}
...
/// write summary
void GaussianMixture::writeSummary(void){
    testResults("final_results.txt", features, output);
    testResults("final_results_test.txt", testInput, testOutput);
}

/// write summary
void GaussianMixture::writeSummary(const Eigen::MatrixXd& inputTest, const Eigen::MatrixXd& outputTest){
    (void) inputTest;
    (void) outputTest;
}
